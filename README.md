...
5. YourselfLM 連携
- 設定画面で送信を ON にすると、記録追加時に要約を外部サービスへ送信
- 送信内容はイベント名、開始/終了時刻、記録時刻、記録種別、メモ本文、添付数
